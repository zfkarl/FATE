...
def dataset(config, filename, transform_mode):
    ...
    if dataset_name == 'celeba':
            ...
            d = datasets.celeba(transform=transform, filename=filename, reset=reset)
        ...
        if transform_mode == 'train':
            ...
            transform = compose_transform('test', resizec, cropc, norm)
        d = datasets.utk(transform=transform, filename=filename, reset=reset)
        ...
        if transform_mode == 'train':
            ...
            transform = compose_transform('test', resizec, cropc, norm)
        d = datasets.utk_multicls2(transform=transform, filename=filename, reset=reset)
