...
parser.add_argument('--nbit', default=128, type=int, help='number of bits')
parser.add_argument('--bs', default=512, type=int, help='batch size')
parser.add_argument('--lr', default=0.0001, type=float, help='learning rate')
parser.add_argument('--epochs', default=100, type=int, help='training epochs')
parser.add_argument('--ds', default='utkface_multicls2', choices=['utkface','utkface_multicls','celeba','utkface_multicls2'],
                    help='dataset')
